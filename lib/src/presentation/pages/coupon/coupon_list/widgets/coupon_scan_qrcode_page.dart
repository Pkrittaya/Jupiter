...
class ScanQRCodeCouponPage extends StatefulWidget {
  const ScanQRCodeCouponPage({Key? key, this.listItemCollect})
      : super(key: key);

  final List<SearchCouponItemEntity>? listItemCollect;

  @override
  State<ScanQRCodeCouponPage> createState() => _ScanQRCodeCouponPageState();
}

class _ScanQRCodeCouponPageState extends State<ScanQRCodeCouponPage> {
  ...
  void actionScanQrcodeCouponSuccess(SearchCouponItemEntity? couponEntity) {
                      ...
                      children: [
                        Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                SvgPicture.asset(
                                    ImageAsset.ic_permission_camera),
                                const SizedBox(height: 24),
                                TextLabel(
                                  text:
                                      translate('qrcode_page.permission.title'),
                                  fontSize:
                  ...
                  : Stack(
                      children: [
                        ...
                        renderTextPosition(
                          ...
                          text: translate(
                              'coupon.coupon_list.scan_qrcode_view_detail'),
                          fontSize: Utilities.sizeFontWithDesityForDisplay(
